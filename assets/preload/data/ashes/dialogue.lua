local Turnos = {'dad', 'bf', 'dad', 'gf','dad','bf','dad','bf','dad'}
local TurnosNombres = {'Maroon', 'Boyfriend', 'Maroon', 'Girlfriend','Maroon','Boyfriend','Maroon','Boyfriend','Maroon'}
local Emociones = {'happy', 'neutral', 'threat', 'mad', 'happy', 'angry', 'happy', 'neutral', 'threat'}
local Numero = 1
local NumeroI2 = 0
local NumeroFinal = 10
...
addAnimationByPrefix('Portraitbf', 'angry', 'angry', 24, false);
...
makeAnimatedLuaSprite('Portraitdad', 'Stages/dialogueV4/maroon', 240, 265);
addAnimationByPrefix('Portraitdad', 'happy', 'happy', 24, false);  
addAnimationByPrefix('Portraitdad', 'threat', 'threatening', 24, false);
addAnimationByPrefix('Portraitdad', 'sad', 'sad', 24, false);
...
addAnimationByPrefix('dialogueBox', 'dad', 'dad5', 24, false);
...
addAnimationByPrefix('icon1', 'dad', 'maroon', 24, false);
...
addAnimationByPrefix('icon2', 'dad', 'maroon', 24, false);
